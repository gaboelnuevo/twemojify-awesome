         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            function insertEmojicon(args) {
                ...
                if(args.replacer){
                    ...
                    if (elementType !== 'img' || elementType == "i") {
                        if(elementType == "i"){
                          var stremoji = args.emojiName.replace(/_/g, "-");
                          if(defaultConfig.size !=""){
                            emojiElement.setAttribute('class', 'twa '+defaultConfig.size+' twa-' + stremoji);
                          }else{
                            emojiElement.setAttribute('class', 'twa twa-' + stremoji);
                          }
                        }else{
